...
class ViewController: UIViewController {
    ...
    func setupViews() {
        ...
        ouputCardView.layer.cornerRadius = 8
        ouputCardView.layer.masksToBounds = true
        
        // set output card border
        ouputCardView.layer.borderWidth = 1
        ouputCardView.layer.borderColor = UIColor.tcHotPink.cgColor
